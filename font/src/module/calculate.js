 ...
 */
calculate.accAdd = function (arg1, arg2) {
    let r1, r2, m, c;
 ...
 ** 返回值：arg1加上arg2的精确结果
 **/
calculate.accSub = function (arg1, arg2) {
    let r1, r2, m, n;
    try {r1 = arg1.toString().split(".")[1].length;}
    catch (e) {r1 = 0;}
    try {r2 = arg2.toString().split(".")[1].length;}
 ...
 **/
calculate.accMul = function (arg1, arg2) {
 ...
 ** 返回值：arg1除以arg2的精确结果
 **/
calculate.accDiv = function (arg1, arg2) {
    let t1 = 0, t2 = 0, r1, r2;
...
calculate.toDecimal2 = function(x){
    let w = parseFloat(x);
